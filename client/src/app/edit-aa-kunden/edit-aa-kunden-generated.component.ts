/*
  ...
  Modify edit-aa-kunden.component.ts instead.
*/
...
export class EditAaKundenGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  load() {
    this.dbSinDarEla.getKundenByKundenId(null, this.parameters.KundenID)
  ...
  form0Submit(event: any) {
    this.dbSinDarEla.updateKunden(null, this.parameters.KundenID, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to update Kunden` });
    });
  }
