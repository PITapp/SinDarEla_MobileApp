/*
  ...
  Modify base-details.component.ts instead.
*/
...
export class BaseDetailsGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  load() {
    this.paramBaseID = this.parameters.baseID;

    this.dbSinDarEla.getBases(null, null, null, null, null, null, null, null)
    .subscribe((result: any) => {
      this.baseAntwort = result.antwort;
    }, (result: any) => {

    });

    document.getElementById("headerDetailsTitel").innerHTML = '<div style="color: #f5f5f5; font-size: 20px; width: 100%; text-align: center;">Antwort</div>'
  }
}
