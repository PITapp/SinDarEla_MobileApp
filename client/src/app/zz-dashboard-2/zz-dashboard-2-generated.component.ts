/*
  ...
  Modify zz-dashboard-2.component.ts instead.
*/
...
export class ZzDashboard2Generated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  @ViewChild('label39') label39: LabelComponent;
