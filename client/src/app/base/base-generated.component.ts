...
export class BaseGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  grid0LoadData(event: any) {
    this.dbSinDarEla.getBases(`${event.filter}`, event.top, event.skip, `${event.orderby}`, event.top != null && event.skip != null, `BaseAnreden`, null, null)
  ...
  grid0Delete(event: any) {
    this.dbSinDarEla.deleteBase(event.BaseID)
    .subscribe((result: any) => {
